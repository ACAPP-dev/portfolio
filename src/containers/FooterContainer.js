...
export default class FooterContainer extends React.Component {
  render() {
    return (
      <div id="footer-div">
        <a
          href="https://github.com/ACAPP-dev"
          className="footer"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/acapp-web-dev"
          className="footer"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        >
          <img
            ...
            src="https://static.websitehostserver.net/ggseal/Green_3.png"
            alt="Greengeeks Seal"
          />
        </a>
        {/* <!-- End GreenGeeks Seal Code --></div> */}

        <span className="footer">Last Updated: January 2021</span>
      </div>
    );
  }
}
